...
# DEPRECATED - remove in a migration once supplier update admin app has been updated
db.Index(
...
db.Index(
    ...
    AuditEvent.created_at,
    AuditEvent.id,
    postgresql_where=sql_and(AuditEvent.acknowledged == sql_false(), AuditEvent.type == "supplier_update"),
)
